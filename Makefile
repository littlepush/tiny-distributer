...
TD_DEFINES = -DVERSION=\"$(shell ./version)\" -DTARGET=\"$(shell gcc -v 2> /dev/stdout | grep Target | cut -d ' ' -f 2)\" -I./inc -std=c++11 -DUSE_THREAD_SERVICE #-DAUTO_TCPRELAY_SOCKS5 -DTCPRELAY_DIRECT_TIMEOUT=200
